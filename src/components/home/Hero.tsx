  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="grid gap-4 md:h-[70vh] md:grid-cols-[70%_30%]">
        <div className="relative aspect-[4/5] overflow-hidden rounded-[18px] shadow-lg shadow-slate-900/10 sm:aspect-[16/10] md:h-full md:max-h-[70vh] md:aspect-auto">
          <img
        ...
        <div className="grid gap-4 md:h-full md:max-h-[70vh] md:grid-rows-2">
